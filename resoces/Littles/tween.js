...
(function(){
	...
	window.startMove2 = function(obj,json,options){
		clearInterval(obj.timer);
		options = options || {};
		options.time = options.time || 3000;
		options.type = options.type || Tween.Elastic.easeInOut;
		var start = {};
		var dis = {};
		...
		obj.timer = setInterval(function(){
			n++;
			for(var name in json){
				var fx = Tween.Bounce.easeIn;
				var cur = fx(n*20,start[name],dis[name],options.time);
				if(name == 'opacity'){
